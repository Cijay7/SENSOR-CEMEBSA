...
export function AboutPage() {
  return (
    <div className="space-y-8">
      ...
      {/* Profile Card */}
      <Card className="p-8 max-w-md mx-auto" gradient>
        <div className="text-center">
          <div className="mb-6 flex justify-center">
            <img 
              src={profile.photo} 
              alt={profile.name}
              className="w-32 h-32 rounded-full border-4 border-blue-400 shadow-lg shadow-blue-500/25"
            />
          </div>
          ...
          <div className="space-y-1 mb-4">
            ...
            <p className="text-lg font-medium text-blue-400">{profile.nim}</p>
          </div>
          <p className="text-sm text-slate-500">
            Student Developer - Dashboard Sensor Project
          </p>
        </div>
      </Card>
